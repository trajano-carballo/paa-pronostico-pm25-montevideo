...
- Cobertura de PM2.5: **94.29 %** de las horas con al menos un registro.

## Cadencia detectada

Derivada de la moda del delta entre timestamps consecutivos, por mes.

Estable en **60 s** (60 registros/hora) en los 29 meses del periodo. Sin cambios de cadencia.

## Completitud horaria

| Categoria | Criterio | Horas | % |
|---|---|---|---|
| Completas | n_registros >= 75 % de n_esperados | 19773 | 94.05 % |
| Parciales | entre 1 y 74 % | 50 | 0.24 % |
| Vacias | n_registros = 0 | 1201 | 5.71 % |
...
Total de rachas: **21** — 1201 horas vacias — racha maxima **505 h**.
...
| `temperatura` | 60 | 0.29 % |
| `humedad_relativa` | 60 | 0.29 % |
| `velocidad_viento` | 60 | 0.29 % |
| `visibilidad` | 60 | 0.29 % |
| `viento_u` | 60 | 0.29 % |
| `viento_v` | 60 | 0.29 % |
